  ...
  return (
    <footer className="py-4">
      <div className="container flex flex-col items-center justify-center px-4 mx-auto">
        <p className="mb-2 text-sm text-center text-gray-500 dark:text-gray-800">
          &copy; {new Date().getFullYear()} Made With 💌
        </p>
        <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-6">
          <a 
            href="#" 
            className="flex items-center transition text-violet-300 hover:text-violet-500 dark:text-gray-400 dark:hover:text-violet-400"
          >
